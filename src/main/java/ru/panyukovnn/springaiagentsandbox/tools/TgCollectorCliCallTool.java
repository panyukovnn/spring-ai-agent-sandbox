...
public class TgCollectorCliCallTool {
    ...
    private String loadSubtitles(String videoUrl) {
        ...
        pb.command().add("/Users/nikolay/java/shell-services/article-parser-1.0.0-RC2.jar");
